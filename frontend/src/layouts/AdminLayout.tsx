...
const adminLinks = [
  ...
  { to: "/admin/career-paths", label: "Career Paths", icon: "CP" },
  { to: "/admin/skill-nodes", label: "Skill Nodes", icon: "SN" },
  { to: "/admin/portfolio-projects", label: "Portfolio Projects", icon: "PP" },
];
    ...
    <div className="relative isolate min-h-screen overflow-hidden bg-slate-50 bg-gradient-to-br from-indigo-50 via-white to-violet-50 text-slate-950">
      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/85 backdrop-blur">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          <Link className="flex items-center gap-3 text-lg font-bold" to="/admin/dashboard">
